...
export default function PieChart({ results, products }) {
    ...
    useEffect(() => {
        ...
        const colors = [
            '--blue-500', '--yellow-500', '--green-500', '--purple-500', 
            '--red-500', '--orange-500', '--cyan-500', '--pink-500', 
            '--teal-500', '--lime-500', '--amber-500', '--indigo-500', '--gray-500'
        ];
            ...
            plugins: {
                legend: {
                    labels: {
                        usePointStyle: true,
                        font: {
                            size: 19 // Increase the legend font size
                        }
                    }
                },
                tooltip: {
